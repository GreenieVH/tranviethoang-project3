            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="loginFront/images/signin-image.jpg" alt="sing up image"></figure>
                        <a href="/Project3/signup" class="signup-image-link">Create an account</a>
                    </div>
                    ...
                    <div class="signin-form">
                        ...
                        <form class="register-form" id="login-form">
                            <div class="form-group">
                                ...
                                <input type="text" id="userAccount" placeholder="Your Account"/>
                            </div>
                            <div class="form-group">
